...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="hidden lg:flex lg:flex-1 items-center justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 relative overflow-hidden">
        <div className="absolute inset-0 bg-black bg-opacity-20"></div>
        <div className="relative z-10 flex flex-col items-center text-center text-white p-8">
          <div className="mb-8">
            <Earth />
          </div>
          <h2 className="text-4xl font-bold mb-4">Welcome to GeoJournal</h2>
          <p className="text-xl text-blue-100 max-w-md">
            Explore the world and document your journey with our interactive
            platform
          </p>
        </div>
        {/* Decorative elements */}
        <div className="absolute top-10 left-10 w-20 h-20 border-2 border-blue-300 rounded-full opacity-30"></div>
        <div className="absolute bottom-10 right-10 w-16 h-16 border-2 border-blue-300 rounded-full opacity-20"></div>
        <div className="absolute top-1/3 right-20 w-12 h-12 border-2 border-blue-400 rounded-full opacity-25"></div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4 lg:p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign in to your GeoJournal account</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            ...
            <div className="w-full">
              <button
                ...
                className="flex w-full items-center justify-center px-4 py-2 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors"
              >
