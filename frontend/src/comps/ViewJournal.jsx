...
function ViewJournal({ entryId }) {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col md:flex-row bg-[#1E2939] text-black p-8 font-sans">
      {/* Left Panel */}
        ...
        <div className="flex items-center gap-6 mb-6">
          <button
            ...
            className={`flex items-center gap-2 ${
              likes.status ? "bg-red-500" : "bg-gray-300"
            } text-white px-4 py-2 rounded-full shadow hover:bg-gray-800 transition`}
          >
            <Heart size={20} /> <span>{likes.status ? "Unlike" : "Like"}</span>
          </button>
